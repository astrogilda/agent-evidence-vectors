...
AVE records were read from the published corpus on 2026-07-28, 59 in total. The AEE field vocabulary comes from spec/predicates/adversarial-execution-evidence.md in this repository. The conformance suite is at revision 18 with 220 vectors, 50 accept, 168 reject and 2 indeterminate, per vectors/MANIFEST.json. The predicate is under review as in-toto/attestation pull request 570.
