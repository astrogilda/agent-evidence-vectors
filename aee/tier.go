...
// GATE 2 — the per-row evidence tier (spec:726-735). Trust-relative and
...
// beginning with "aee" are reserved (spec:735-739).
const (
...
//     the bottom of both orderings (spec:1074-1075) and is reported declared —
