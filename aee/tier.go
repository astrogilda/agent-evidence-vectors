...
// GATE 2 — the per-row evidence tier (spec:433-442). Trust-relative and
...
// from the predicate (spec:438-441). A record's keyid is an unauthenticated
// lookup hint and never the check itself (spec:1098-1100): verification below
...
// beginning with "aee" are reserved (spec:442-446).
const (
...
//     the bottom of both orderings (spec:691-692) and is reported declared —
