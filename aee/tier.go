...
// GATE 2 — the per-row evidence tier (spec:740-749). Trust-relative and
...
// from the predicate (spec:745-748). A record's keyid is an unauthenticated
// lookup hint and never the check itself (spec:1773-1775): verification below
...
// beginning with "aee" are reserved (spec:749-753).
const (
...
//     the bottom of both orderings (spec:1088-1089) and is reported declared —
