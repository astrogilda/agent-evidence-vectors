...
// GATE 2 — the per-row evidence tier (spec:537-546). Trust-relative and
...
// from the predicate (spec:542-545). A record's keyid is an unauthenticated
// lookup hint and never the check itself (spec:1233-1235): verification below
...
// beginning with "aee" are reserved (spec:546-550).
const (
...
//     the bottom of both orderings (spec:820-821) and is reported declared —
