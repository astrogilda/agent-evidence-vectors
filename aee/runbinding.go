...
// (spec:180-185). There is deliberately exactly ONE construction here.
const BindingVersion = "1"

// RunBindingPreimage builds the RFC 8785 canonical bytes of the binding
// pre-image object (spec:127-132):
//
...
// verbatim (no case-folding, no null fill, spec:167-168); a value that is not
