...
for it, and without taking this page's. Four commands settle it.
...
digest from the vector files through the routine that corpus publishes, so a line
...
attestation has not landed. `.github/workflows/ots-upgrade.yml` runs weekly and
