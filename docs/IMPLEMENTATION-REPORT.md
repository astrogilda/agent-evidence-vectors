...
| `ts-verify` | TypeScript | spec author | its vendored set (118 vectors) + cross-rail parity tests | pass (see note 2) |
| `py-verify` | Python | spec author | its vendored set (118 vectors) + parity tests | pass (see note 2) |
| MCP server rail `_aee.py` | Python | spec author | its vendored set (132 vectors) + parity tests | pass (see note 2) |
