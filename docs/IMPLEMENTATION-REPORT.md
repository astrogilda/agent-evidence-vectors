...
Corpus SSOT: vectors/MANIFEST.json (suiteRevision 21, 231 vectors: 54 accept, 175 reject, 2 indeterminate).
...
`vectors/MANIFEST.json`, suiteRevision 21: **231 vectors (54 accept, 175 reject, 2 indeterminate)**.
