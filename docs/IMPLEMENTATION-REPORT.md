...
Corpus SSOT: vectors/MANIFEST.json (suiteRevision 26, 258 vectors: 60 accept, 196 reject, 2 indeterminate).
...
`vectors/MANIFEST.json`, suiteRevision 26: **258 vectors (60 accept, 196 reject, 2 indeterminate)**.
