...
Corpus SSOT: vectors/MANIFEST.json (suiteRevision 27, 260 vectors: 61 accept, 197 reject, 2 indeterminate).
...
`vectors/MANIFEST.json`, suiteRevision 27: **260 vectors (61 accept, 197 reject, 2 indeterminate)**.
...
|---|---|---|---|---|
| Reference rail (`aee/`) | Go | spec author | reference corpus, suiteRevision 27 | **260 / 260** |
| Reference rail (`packaging/run_vectors.py`) | Python | spec author | reference corpus, suiteRevision 27 | **260 / 260** |
...
Nor does agreement on 260 vectors say anything about the surface no vector
