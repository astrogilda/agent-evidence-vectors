...
Corpus SSOT: vectors/MANIFEST.json (suiteRevision 13, 179 vectors: 44 accept, 135 reject).
...
`vectors/MANIFEST.json`, suiteRevision 13: **179 vectors (44 accept, 135 reject)**.
...
|---|---|---|---|---|
| Reference rail (`aee/`) | Go | spec author | reference corpus, suiteRevision 13 | **179 / 179** |
| Reference rail (`packaging/run_vectors.py`) | Python | spec author | reference corpus, suiteRevision 13 | **179 / 179** |
